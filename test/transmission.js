...
transmission.Init(function(err) {
    console.log(err);
/*    transmission.AddTorrent('test/123.torrent', function(err, hash, id) {
        console.log(err);
        console.log(hash);
        console.log(id);
    ...
    transmission.CheckDownloadState('773d1ac2a23ca59b3cd14a041a476d83583a2ed6',function(err, arg){
        console.log(err);
        console.log(arg);
    });
