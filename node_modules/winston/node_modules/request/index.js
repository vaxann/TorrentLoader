...
Request.prototype.onResponse = function (response) {
  ...
  if (self.httpModule === https &&
      self.strictSSL &&
      !response.application.authorized) {
    debug('strict ssl error', self.uri.href)
    var sslErr = response.application.authorizationError
...
Request.prototype.hawk = function (opts) {
  this.headers.Authorization = hawk.application.header(this.uri, this.method, opts).field
}
