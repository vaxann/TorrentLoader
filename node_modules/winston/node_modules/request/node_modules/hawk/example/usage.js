...
var header = Hawk.application.header('http://127.0.0.1:8000/resource/1?b=1&a=2', 'GET', { credentials: internals.credentials.dh37fgj492je, ext: 'and welcome!' });
var options = {
...
Request(options, function (error, response, body) {
    ...
    var isValid = Hawk.application.authenticate(response, header.artifacts, { payload: body });
