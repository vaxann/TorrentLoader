    ...
    describe('README', function () {
        ...
        describe('core', function () {
            ...
            it('should generate a header protocol example', function (done) {
                ...
                var header = Hawk.application.header('http://example.com:8000/resource/1?b=1&a=2', 'GET', options).field;
            ...
            it('should generate a header protocol example (with payload)', function (done) {
                ...
                var header = Hawk.application.header('http://example.com:8000/resource/1?b=1&a=2', 'POST', payloadOptions).field;
