...
describe('Hawk', function () {
    ...
    it('should generate a header then successfully parse it (configuration)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            req.authorization = Hawk.application.header(Url.parse('http://example.com:8080/resource/4?filter=a'), req.method, { credentials: credentials, ext: 'some-app-data' }).field;
    ...
    it('should generate a header then successfully parse it (node request)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            var reqHeader = Hawk.application.header('http://example.com:8080/resource/4?filter=a', req.method, { credentials: credentials, ext: 'some-app-data', payload: payload, contentType: req.headers['content-type'] });
            ...
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials, artifacts) {
                ...
                expect(Hawk.application.authenticate(res, artifacts, { payload: 'some reply' })).to.equal(true);
                done();
            });
        });
    });
    ...
    it('should generate a header then fails to parse it (missing server header hash)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials, artifacts) {
                ...
                expect(Hawk.application.authenticate(res, artifacts, { payload: 'some reply' })).to.equal(false);
                done();
            });
        });
    });
    ...
    it('should generate a header then successfully parse it (with hash)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            req.authorization = Hawk.application.header('http://example.com:8080/resource/4?filter=a', req.method, { credentials: credentials, payload: 'hola!', ext: 'some-app-data' }).field;
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials, artifacts) {
    ...
    it('should generate a header then successfully parse it (app)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            req.authorization = Hawk.application.header('http://example.com:8080/resource/4?filter=a', req.method, { credentials: credentials, ext: 'some-app-data', app: 'asd23ased' }).field;
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials, artifacts) {
    ...
    it('should generate a header then successfully parse it (app, dlg)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            req.authorization = Hawk.application.header('http://example.com:8080/resource/4?filter=a', req.method, { credentials: credentials, ext: 'some-app-data', app: 'asd23ased', dlg: '23434szr3q4d' }).field;
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials, artifacts) {
    ...
    it('should generate a header for one resource then fail to authenticate another', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            req.authorization = Hawk.application.header('http://example.com:8080/resource/4?filter=a', req.method, { credentials: credentials, ext: 'some-app-data' }).field;
