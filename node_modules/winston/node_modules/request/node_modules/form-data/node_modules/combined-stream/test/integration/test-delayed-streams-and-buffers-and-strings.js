...
var FILE1 = common.watchDir.fixture + '/file1.txt';
var BUFFER = new Buffer('Bacon is delicious');
var FILE2 = common.watchDir.fixture + '/file2.txt';
...
(function testDelayedStreams() {
  ...
  var tmpFile = common.watchDir.tmp + '/combined-file1-buffer-file2-string.txt';
